...
Floice Nyota 
## Description
This is a flask application consuming News API to get news sources and retrieve news articles in different sources available.
![alt text]() 
### Prerequisites
...
1. Use this command to clone $ git clone https://github.com/FloiceNyota98/News-app.git
